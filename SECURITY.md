...
Email `security@specora.ai` with the PGP key fingerprint below.

```
-----BEGIN PGP PUBLIC KEY BLOCK-----

[Draft note for legal/ops: generate a dedicated security@specora.ai
PGP key before launch day. Do NOT reuse an existing internal key.
Fingerprint format:

    pub   ed25519 2026-05-15 [SC] [expires: 2029-05-15]
          XXXX XXXX XXXX XXXX XXXX  XXXX XXXX XXXX XXXX XXXX
    uid           Specora Security <security@specora.ai>

Publish the key here, at https://specora.ai/.well-known/security.txt,
and on at least one keyserver (keys.openpgp.org).]

-----END PGP PUBLIC KEY BLOCK-----
```

The key is also available at https://specora.ai/.well-known/security.txt.
